"""Data validation and quality metrics for pollution monitoring."""
...
def get_current_language():
    """Get current language from session state, defaults to English."""
    try:
...
class DataValidator:
    """Validates pollution data and calculates quality metrics."""
    ...
    def calculate_aqi(self, gas: str, concentration: float) -> Dict:
        """Calculate AQI using US EPA and WHO standards."""
        aqi_breakpoints = {
            'NO2': [
    ...
    def _get_health_recommendations(self, category: str) -> str:
        """Get health recommendations for AQI category."""
        lang = get_current_language()
        recommendations = {
    ...
    def validate_measurement(self, gas: str, value: float, unit: str) -> Dict:
        """Validate measurement, returns status and warnings."""
        validation = {
            'valid': True,
            'warnings': [],
            'errors': [],
    ...
    def generate_data_insights(self, pollution_data: Dict, city: str) -> List[str]:
        """Generate insights from pollution patterns."""
        insights = []
        lang = get_current_language()
    ...
    def calculate_health_risk_index(self, pollution_data: Dict) -> Dict:
        """Calculate health risk index with recommendations."""
        risk_scores = {}
        total_risk = 0
        gas_count = 0
