"""Fetch Sentinel-5P satellite data and synchronized wind data via Google Earth Engine."""
...
class SatelliteDataFetcher:
    ...
    def __init__(self):
        """Initialize Earth Engine and wind fetcher."""
    ...
    def fetch_gas_data(self, city: str, gas: str, days_back: int = 3) -> Dict:
        """Retrieve latest satellite measurements for a gas."""
        ...
        try:
            ...
            # Extract spatial statistics from single image
            stats = None
            mean_val = None
            max_val = None
            min_val = None

            # Try progressively coarser scales if fine scale fails
            ...
            # Clamp negative values (sensor noise)
    ...
    def fetch_wind_data(self, city: str, target_time: Optional[datetime] = None) -> Dict:
        """Get wind data matching satellite observation time."""
        ...
        u_component = -wind_data['speed_ms'] * math.sin(direction_rad)
        v_component = -wind_data['speed_ms'] * math.cos(direction_rad)
    ...
    def _fetch_wind_from_source(
        ...
        """Fetch wind from a configured GEE source."""
    ...
    def _compute_wind_confidence(
        ...
        """Estimate wind data confidence (0-100%)."""
    ...
    def _fetch_wind_from_openweathermap(
        ...
        """Fetch wind from OpenWeatherMap API."""
        try:
    ...
    def _create_empty_response(self, city: str, gas: str, error: str = None) -> Dict:
        """Create empty response for failed fetch."""
        return {
            'success': False,
            'city': city,
            'gas': gas,
